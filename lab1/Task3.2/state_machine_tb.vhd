...
begin
	...
	-- instantiate the design-under-test
        ...
        dut : state_machine port map(clk_local, resetb_local, skip_local, hex0_local);
        ...
        -- Create a pattern for the skip input. You can play with this if you want
        -- to better test your design
  
        skip_local <= '1', '0' after 25 ns, '1' after 41 ns;
